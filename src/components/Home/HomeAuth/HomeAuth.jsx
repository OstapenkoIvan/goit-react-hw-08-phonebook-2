...
import { featuresAuth } from 'components/constants';
    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6 md:px-8">
      <div className="md:text-center">
        ...
        <p className="text-md mt-4 max-w-2xl text-gray-500 md:mx-auto">
          To register in this app use any dummy data you wish, it does not
          require confirmation. This contacts app is built mostly as practice
          tool. Tools that were practiced in process include:
        </p>
      </div>

      <dl className="mt-5 space-y-5 sm:grid sm:grid-cols-2 sm:gap-x-8 sm:gap-y-8 sm:space-y-0">
        {featuresAuth.map(feature => (
          <div
            key={feature.name}
